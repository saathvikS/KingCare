...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: VVx6RVlFva_/component
import Select__Option from "../../Select__Option"; // plasmic-import: r1h-ZU7-yr8/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: ToHfe5vpUtB/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: _abfkGGSFDK/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: YU6C-P49nca/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: OmDA_ypw6s_/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__vcSaB)}
              value={"value1" as const}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option__eM5Ed)}
              value={"value2" as const}
            >
              {"Option 2"}
            </Select__Option>
