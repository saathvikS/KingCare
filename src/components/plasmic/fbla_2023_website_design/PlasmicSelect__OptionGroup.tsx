...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: ToHfe5vpUtB/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: _abfkGGSFDK/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__gqoyK)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__zdv1T)}
              />
            </React.Fragment>
          ),
          value: args.children
